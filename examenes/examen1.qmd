...
$$
  f_{xy}(x, y)= \frac{1}{8}x\exp\left[ -(x+y)/s \right]\ x,y > 0
$$
...
$$
  f_{xy}(x, y)= \exp\left( - x\right)\ 0\leq y\leq x < \infty
$$
...
\item (10 puntos). En la figura 1 se muestra una muestra bivariada con $\pmb{\mu}=(1, 1), \rho = -0.6, \sigma_1=2$ y $\sigma_2=8$. Los puntos azul y naranja tienen coordenadas p1=(`r p1`) y p2=(`r p2`) respectivamente. 
