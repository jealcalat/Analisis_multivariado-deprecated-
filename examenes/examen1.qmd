...
\item (15 puntos). Un supermercado cuenta tanto con una caja normal como con una rápida. La función de masa de probabilidad conjunta de $X_1$ el número de clientes formados en la caja normal a una hora particular del día y de $X_2$ el número de clientes formados en la caja rápida a la misma hora está dada por
...
En donde $X_1$ son las filas y $X_2$ las columnas.
