...
# repetimos la curva original con los datos reales, pero en color rojo
curve(
...
estimadores <- nlm(, , , iterlim = 1e5)
```

Luego, realiza un gráfico de histograma y añade 100 simulaciones con los parámetros estimados en el paso anterior.